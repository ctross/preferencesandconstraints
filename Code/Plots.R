...
ggsave("All_Games-Standardized.pdf",p,height=8, width=14)
...
ggsave("Giving_Games-Standardized.pdf",p,height=8, width=14)
...
ggsave("All_Games-NonStandardized.pdf",p,height=8, width=14)
...
ggsave("Giving_Games-NonStandardized.pdf",p,height=8, width=14)
