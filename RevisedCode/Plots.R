...
ggsave("All_Games-Standardized_SRM.pdf",p,height=8, width=14)
...
ggsave("Giving_Games-Standardized_SRM.pdf",p,height=8, width=14)
...
ggsave("All_Games-NonStandardized_SRM.pdf",p,height=8, width=14)
...
ggsave("Giving_Games-NonStandardized_SRM.pdf",p,height=8, width=14)
